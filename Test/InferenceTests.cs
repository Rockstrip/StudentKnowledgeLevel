...
namespace InferenceTests
{
    ...
    public class InferenceTests
    {
        ...
        public void TestNormalSeverity()
        {
            ...
            Assert.AreEqual(result.wordResult.term, Severity.Unsatisfactory);
        }
        ...
        public void TestMildSeverity()
        {
            ...
            Assert.AreEqual(result.wordResult.term, Severity.Satisfactory);
        }
        ...
        public void TestModerateSeverity()
        {
            ...
            Assert.AreEqual(result.wordResult.term, Severity.Good);
        }
        ...
        public void TestSevereSeverity()
        {
            ...
            Assert.AreEqual(result.wordResult.term, Severity.Excellent);
        }
    }
}